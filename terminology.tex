...
\ruby{突}{つき}\ruby{中段}{ちゅう} & \ruby{後}{うしろ}\ruby{捻}{ねじ} & \ruby{肩}{かた}\ruby{関}{かん}\ruby{節}{せつ}\\
...
\ruby{後}{うしろ}\ruby{片}{かた}\ruby{取}{ど}り & えり\ruby{鰤}{じ}め\ruby{行}{ゆ}き\ruby{違}{ちが}え & \ruby{肩}{かた}\ruby{関}{かん}\ruby{節}{せつ}\\
ushiro kata dori & eri jime yuki chigae & ude kansetsu\\
achterwaarts schouder actieve partner & ? & ? gewricht\\
\\
...
achterwaarts bovenste deel (van het lichaam) vastpakken & naartoe gaan en
neerhalen & schouder gewricht\\
\end{tabular}
\end{center}
\label{kihonosaewaza}
\end{table}
