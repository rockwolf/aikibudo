...
\begin{tabular}{B|B}
    ...
    \hline
     & \ruby{襟}{えり}\ruby{取}{ど}り\\
     & eri dori\\
     & \tran{kraag vastpakken}\\
    \hline
     & \ruby{両}{りょう}\ruby{手}{て}\ruby{取}{ど}り\\
     & ry\={o} te dori\\
     & \tran{beide handen vastpakken}\\
    \hline
     & \ruby{下}{した}\ruby{手}{て}\ruby{取}{ど}り\\
     & shitate dori\\
     & \tran{nederige positie vastpakken (onderarm greep op riem tegenstander)}\\
    \hline
     & \ruby{上}{うわ}\ruby{手}{て}\ruby{取}{ど}り\\
     & uwate dori\\
     & \tran{bovenste deel vastpakken (over-arm greep)}\\
    \hline
     & \ruby{片}{}\ruby{手}{て}\ruby{取}{ど}り\ruby{襟}{えり}\ruby{締}{し}め\\
     & katate dori eri shime\\
     & \tran{1 hand vastpakken kraag wurging}\\
\end{tabular}
\end{center}
