...
\begin{center}
\begin{tabular}{|c|c|c|}
    \multicolumn{3}{c}{\ruby{突}{つ}き・Stoot}\\
    \hline
    ...
    \hline
    \multicolumn{3}{c}{}\\
    \multicolumn{3}{c}{\ruby{打}{う}ち・Slag}\\
    \hline
    ...
    \multicolumn{3}{|c|}{buitenkant horizontaal gezicht slag}\\
    \hline
    \multicolumn{3}{|c|}{\ruby{裏}{うら}\ruby{打}{う}ち}\\
    \multicolumn{3}{|c|}{ura yoko men uchi}\\
    \multicolumn{3}{|c|}{achterkant horizontaal gezicht slag}\\
    \hline
\end{tabular}
\end{center}
