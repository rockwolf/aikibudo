...
\begin{tabular}{c|c|c|c}
    ...
    \hline
    \ruby{四方}{しほう}\ruby{斬}{ぎ}り & \ruby{四方}{しほう}\ruby{投}{な}げ & \ruby{}{}の\ruby{型}{かた} & \ruby{短}{たん}\ruby{棒}{ぼう}の\ruby{型}{かた}\\
    shih\={o} giri & shih\={o} nage & ken no kata & tanbo no kata\\
    in elke richting, iemand afmaken met een zwaard & worp in elke richting & ? & korte stok kata
\end{tabular}
\end{center}
\label{kata_dan_1}
\end{table}
