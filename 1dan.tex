...
\begin{center}
    ...
    {\itshape{\color{Gray}8-stappen vuist kata}} & {\itshape{\color{Gray}stoot/slag kata}} & {\itshape{\color{Gray}zittende technieken kata}} & {\itshape{\color{Gray}trap 5 stappen kata}}\\
    \multicolumn{4}{c}{}\\
    ...
    {\itshape{\color{Gray}in elke richting, iemand afmaken met een zwaard}} & {\itshape{\color{Gray}worp in elke richting}} & {\itshape{\color{Gray}zwaard kata}} & {\itshape{\color{Gray}korte stok kata}}
\end{tabular}
\end{center}
\label{kata_dan_1}
\end{table}
