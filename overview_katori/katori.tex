...
\noindent \ruby{行合逆拔之太刀}{long sword, pass by reverse draw}\\
\ruby{前後千鳥之太刀}{long sword, front and back cross-step}\\
\ruby{行合右千鳥之太刀}{long sword, pass by right hand side cross-step}\\
\ruby{逆拔之太刀}{long sword, reverse draw}\\
\ruby{拔討之太刀}{long sword, drawing attack}\\
\\
