...
\pB: \-{O}-gasumi.\\
\pA: Achteruit, naar j\-{o}dan no kamae. Slag recht op het puntje van het zwaard.\\
...
\pB: Eerst naar j\-{o}dan no kamae. En dan inkomen om naar het hoofd aan te vallen.\\
...
Start tegen mekaar.
\pA: Sha no kamae. Maki uchi met voeten samen brengen en dan naar j\-{o}dan gaan.\\
...
\pA: kogasumi opvangen (links uitgestapt, punt naar rechts), gaat dan naar j\-{o}dan no kamae\\
...
\pB: naginata in mateage houding dichter bij je lichaam trekken en je rechtervoet naar achteren bijtrekken. Er staat geen gewicht op, want je gaat zo meteen ronddraaien.\\
\pA: j\-{o}dan no kamae\\
